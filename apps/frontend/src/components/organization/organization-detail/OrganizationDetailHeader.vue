  ...
  <div class="mb-5">
    ...
    <div class="flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-gray-500">
      ...
      <span class="flex items-center gap-2">
        <a v-if="organization.url" v-tooltip="organization.url" :href="organization.url" target="_blank" rel="noopener" class="text-gray-400 hover:text-gray-700 transition-colors">
        ...
        <a v-if="organization.officialEmail" v-tooltip="organization.officialEmail" :href="'mailto:' + organization.officialEmail" class="text-gray-400 hover:text-gray-700 transition-colors">
        ...
        <a v-if="organization.github" v-tooltip="organization.github" :href="'https://github.com/' + organization.github" target="_blank" rel="noopener" class="text-gray-400 hover:text-gray-700 transition-colors">
        ...
        <a v-if="organization.keybase" v-tooltip="organization.keybase" :href="'https://keybase.io/' + organization.keybase" target="_blank" rel="noopener" class="text-gray-400 hover:text-gray-700 transition-colors">
...
// Re-open warnings when they newly appear
watch(hasWarnings, (now, prev) => {
  if (now && !prev) warningManuallyCollapsed.value = false;
});
