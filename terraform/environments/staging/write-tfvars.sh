...
network_overlay_version   = ${NETWORK_OVERLAY_VERSION:-41}
network_ledger_version       = ${NETWORK_LEDGER_VERSION:-27}
network_overlay_min_version   = ${NETWORK_OVERLAY_MIN_VERSION:-40}
network_stellar_core_version   = "${NETWORK_STELLAR_CORE_VERSION:-27.0.0}"
network_quorum_set   = "${NETWORK_QUORUM_SET:-}"
network_known_peers = "${NETWORK_KNOWN_PEERS:-[[\"34.227.72.189\", 11625], [\"18.204.203.239\", 11625], [\"100.48.74.5\", 11625]]}"
...
testnet_network_overlay_version   = ${TESTNET_NETWORK_OVERLAY_VERSION:-41}
testnet_network_ledger_version       = ${TESTNET_NETWORK_LEDGER_VERSION:-27}
testnet_network_overlay_min_version   = ${TESTNET_NETWORK_OVERLAY_MIN_VERSION:-40}
testnet_network_stellar_core_version   = "${TESTNET_NETWORK_STELLAR_CORE_VERSION:-27.0.0}"
