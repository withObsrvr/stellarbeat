...
module "app_platform" {
  ...
  frontend_env = {
    API_URL                             = "https://stellarbeat-staging.withobsrvr.com/api"
    API_KEY                             = var.staging_api_key
    NODE_ENV                            = "staging"
    VUE_APP_PUBLIC_API_URL              = "https://stellarbeat-staging.withobsrvr.com/api"
    VUE_APP_TEST_API_URL                = "https://stellarbeat-staging.withobsrvr.com/testnet-api" # Path to testnet API
    VUE_APP_BLOG_URL                    = "https://www.withobsrvr.com/blog"
    VUE_APP_API_DOC_URL                 = "https://stellarbeat-staging.withobsrvr.com/api/docs/"
    ...
    VUE_APP_BRAND_LOGO_ALT              = "Stellarbeat powered by Obsrvr"
