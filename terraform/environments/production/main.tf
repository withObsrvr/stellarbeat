...
module "app_platform" {
  ...
  frontend_env = {
    API_URL                             = "https://radar.withobsrvr.com/api"
    API_KEY                             = var.app_api_key
    NODE_ENV                            = "production"
    VUE_APP_PUBLIC_API_URL              = "https://radar.withobsrvr.com/api"
    VUE_APP_TEST_API_URL                = "https://radar.withobsrvr.com/testnet-api" # Path to testnet API
    VUE_APP_BLOG_URL                    = "https://www.withobsrvr.com/blog"
    VUE_APP_API_DOC_URL                 = "https://radar.withobsrvr.com/api/docs/"
