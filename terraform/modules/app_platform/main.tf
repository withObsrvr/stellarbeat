  ...
  spec {
    ...
    dynamic "service" {
      ...
      content {
        ...
        build_command = "corepack enable && corepack prepare pnpm@9.15.0 --activate && pnpm install && pnpm build:ts && pnpm --filter shared run post-build && pnpm --filter users run build"
