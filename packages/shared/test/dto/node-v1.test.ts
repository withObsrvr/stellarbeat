...
export function createDummyNodeV1(){
    ...
    // Add missing trust rank fields
    obj.connectivityError = false;
    obj.stellarCoreVersionBehind = false;
    obj.lag = null;
    obj.trustCentralityScore = 85;
    obj.pageRankScore = 75;
    obj.trustRank = 3;
    obj.lastTrustCalculation = "2023-02-15T15:30:16.616Z";
    return obj;
}